/*Desafio - Seu sobrinho começou a ganhar mesada dos pais. 
...
public class Mesada {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Por quantos meses você polpará o dinheiro? ");
        int entrada = leitor.nextInt();
        System.out.print("Você terá " + (entrada * mesada) + " reais!");
